...
import { ApiContext, Comment, Post } from "./api";
...
export const Comments = () => {
  ...
  console.log("sta commentando " + user);
  ...
  function stampaCommenti(comments: Comment[]) {
  ...
  return (
    <>
      {statusComment === "loading" || status === "loading" ? (
        ...
        <>
          <StyledCounter>{stampaPost(singlePost)}</StyledCounter>
          <StyledCounter>
            <Box
              component="form"
              sx={{
